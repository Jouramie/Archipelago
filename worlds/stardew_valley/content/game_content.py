...
from typing import Iterable, Any, Mapping, Generator, TYPE_CHECKING
...
class StardewContent:
    ...
    def tag_item(self, item_name: str, *tags: "ItemTag") -> None:
        item = self.game_items.setdefault(item_name, GameItem(item_name))
        item.add_tags(tags)

    def untag_item(self, item_name: str, tag: "ItemTag") -> None:
